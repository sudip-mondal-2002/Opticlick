...
function ScreenshotModal({ src, onClose }: { src: string; onClose: () => void }) {
  return (
    ...
    >
      ...
      {/* Image — fills remaining space, scrollable if tall */}
      <div
  ...
  return (
    <>
      ...
      <div className="px-3 py-3 bg-white dark:bg-slate-950">
        <div className="rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700/70 shadow-[0_4px_24px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)]">

          {/* macOS-style titlebar */}
          <div className="flex items-center gap-1.5 px-3 py-2.5 bg-slate-100 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700/70">
          ...
          <div
            ref={logRef}
            className="log-scroll h-[148px] overflow-y-auto bg-slate-50 dark:bg-slate-950 px-3 py-2.5 font-mono text-[11px] leading-[1.8]"
          >
            {logs.length === 0 ? (
