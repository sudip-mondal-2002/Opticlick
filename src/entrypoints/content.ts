...
import { handleGetElementDom } from './content/handlers/get-element-dom';
import { handleUploadFile } from './content/handlers/upload-file';
    ...
    chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
      switch (msg.type) {
        ...
        case 'GET_ELEMENT_DOM': {
          handleGetElementDom(msg as { x: number; y: number }, sendResponse);
          break;
        }
