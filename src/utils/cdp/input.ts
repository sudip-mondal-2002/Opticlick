...
/**
 * Simulate a hardware-level double-click via Input.dispatchMouseEvent.
 */
export async function dispatchDoubleClick(
  ...
  await attachDebugger(tabId);
  const base = { x: cssX, y: cssY, button: "left" as const, modifiers: 0 };
...
/**
 * Simulate a hardware right-click via Input.dispatchMouseEvent.
 */
...
/**
 * Simulate a mouse hover by moving the cursor to the element and holding.
 */
